...
(function() {
  ...
  grammar = {
    ...
    SelectQuery: [o("SelectWithLimitQuery"), o("SelectWithOffsetQuery"), o("BasicSelectQuery")],
    BasicSelectQuery: [
    ...
    SelectWithOffsetQuery: [
      o('SelectQuery OffsetClause', function() {
        $1.offset = $2;
        return $1;
      })
    ],
    ...
    SelectClause: [
      ...
      }), o('SELECT DISTINCT ON LEFT_PAREN Fields RIGHT_PAREN Fields FROM Table', function() {
        return new Select($7, $9, $5);
      }), o('SELECT DISTINCT ON LEFT_PAREN Fields RIGHT_PAREN Fields FROM Table Joins', function() {
        return new Select($7, $9, $5, $10);
      })
    ],
    Table: [
      o('TableReference', function() {
        return new Field($1);
      }), o('TableReference AS Literal', function() {
    ...
    Join: [
      o('JOIN Table ON Expression', function() {
        ...
        return new Join($3, $5, null, 'INNER');
    ...
    OrderArg: [
      ...
      }), o('Field DIRECTION', function() {
        return new OrderArgument($1, $2);
      }), o('OrderArg NULLS', function() {
        $1.nulls = $2.replace(/^NULLS /, '');
        return $1;
      })
    ],
    GroupClause: [
    ...
    PartitionClause: [
      o('PartitionBasicClause'), o('PartitionBasicClause OrderClause', function() {
        $1.order = $2;
        return $1;
      })
    ],
    PartitionBasicClause: [
      o('PARTITION BY ArgumentList', function() {
    ...
    Expression: [
      o('LEFT_PAREN Expression RIGHT_PAREN', function() {
        ...
        return new Op($2, $1, $3);
      }), o('Expression OPERATOR ARRAY_OPERATOR Expression', function() {
        return new Op($2, $1, new ArrayOp($3, $4));
    ...
    Function: [
      ...
      }), o("Function Over", function() {
        $1.over = $2;
        return $1;
      })
    ],
    Over: [
      o("OVER LEFT_PAREN ArgumentList RIGHT_PAREN", function() {
        return new FunctionValue($1, $3);
      }), o("OVER LEFT_PAREN PartitionClause RIGHT_PAREN", function() {
        return new FunctionValue($1, [$3]);
      })
    ],
    UserFunction: [
